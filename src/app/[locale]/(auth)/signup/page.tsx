  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center">
      ...
      <div className="relative z-10 flex items-center justify-center text-center text-white w-full px-4 sm:px-6">
        ...
        >
          <div>
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold mb-2 sm:mb-4">Sign Up</h1>
          ...
          <div className="mb-3 md:mb-4 text-start">
            ...
            {formik.touched.firstName && formik.errors.firstName && (
              <div className="text-red-500 text-xs sm:text-sm">{formik.errors.firstName}</div>
            )}
          </div>
          ...
          <div className="mb-3 md:mb-4 text-start">
            ...
            {formik.touched.lastName && formik.errors.lastName && (
              <div className="text-red-500 text-xs sm:text-sm">{formik.errors.lastName}</div>
            )}
          </div>
